#ifndef ANIMATIONTESTMODELACTION_MOC_H_
#define ANIMATIONTESTMODELACTION_MOC_H_

/* -*- c++ -*- */
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   AnimationTestModelAction.h
...
/**Animation test model action*/
class AnimationTestModelAction : public ModelAction
{
    Q_OBJECT
public:
     ...
     *
     */
    AnimationTestModelAction(int32_t _priority,
            IScreenTemplate::screenTemplate_enum _templ,
            std::string _label, std::string _title,
            const std::string &_image_on = 0, const std::string &_image_off = 0);
