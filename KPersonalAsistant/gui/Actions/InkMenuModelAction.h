#ifndef INKMENUMODELACTION_MOC_H_
#define INKMENUMODELACTION_MOC_H_

/* -*- c++ -*- */
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   InkTestListMenuModelAction.h
...
class InkMenuModelAction : public ModelAction, public IMenuAction
{
    Q_OBJECT
public:
    /**
     ...
     *
     */
    InkMenuModelAction(int32_t _priority,
