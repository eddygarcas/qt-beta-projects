#ifndef PROGRESSTESTMODELACTION_MOC_H_
#define PROGRESSTESTMODELACTION_MOC_H_

/* -*- c++ -*- */
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   ProgressTestModelAction.h
...
class ProgressTestModelAction : public ModelAction
{
    Q_OBJECT
public:
     ...
     *
     */
    ProgressTestModelAction(int32_t _priority,
...
#endif /*PROGRESSTESTMODELACTION_MOC_H_*/
