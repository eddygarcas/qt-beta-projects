#ifndef TOPLEVELMODELACTION_H_
#define TOPLEVELMODELACTION_H_

/* -*- c++ -*- */
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   TopLavelModelAction.h
...
#include <string>
/**Top level model action*/
class TopLevelModelAction : public ModelAction
{
    Q_OBJECT
public:
     ...
     *
     */
    TopLevelModelAction(int32_t _priority,
...
private:
    ...
    /**Instance of IPrinterInformation, which will be used to obtain data to show in top level screen*/
    //IPrinterInformation* printerInformation_;
};

#endif /*TOPLEVELMODELACTION_H_*/
