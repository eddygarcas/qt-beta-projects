...
#ifndef MAINMENUTEMPLATE_MOC_H_
#define MAINMENUTEMPLATE_MOC_H_
...
class MainMenuTemplate : public QWidget, protected Ui::MainMenuScreen, public ScreenTemplate, public IMenuTemplate
{
    Q_OBJECT
public:
     ...
     * @param *parent
     */
    MainMenuTemplate(QWidget *parent = 0);
