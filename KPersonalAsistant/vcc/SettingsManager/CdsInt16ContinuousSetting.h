#ifndef CDSINT16CONTINUOSSETTING_H_
#define CDSINT16CONTINUOSSETTING_H_

/* -*- c++ -*- */
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   CdsInt16ContinuousSetting.h
 ...
 */
class CdsInt16ContinuousSetting : public ContinuousSetting {
public:
   ...
   * @param cds
   */
  CdsInt16ContinuousSetting(int32_t settingId, ICds* cds);

  /*
   * Destructor
   */
  ~CdsInt16ContinuousSetting();
...
#endif /*CDSINT16CONTINUOSSETTING_H_*/
