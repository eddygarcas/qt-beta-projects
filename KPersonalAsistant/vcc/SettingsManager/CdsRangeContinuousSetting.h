#ifndef CDSRANGECONTINUOUSSETTING_H_
#define CDSRANGECONTINUOUSSETTING_H_
/* -*- c++ -*- */
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   CdsRangeContinuousSetting.h
 ...
 */
class CdsRangeContinuousSetting : public ContinuousSetting {
public:
   ...
   * @param cds
   */
  CdsRangeContinuousSetting(int32_t settingId, ICds* cds);

  /*
   * Destructor
   */
  ~CdsRangeContinuousSetting();
...
#endif /*CDSRANGECONTINUOUSSETTING_H_*/
