...
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   CdsBoolDiscreteSetting.cpp
 ...
 * Constructor
 */
CdsBoolDiscreteSetting::CdsBoolDiscreteSetting(int32_t settingId, ICds* cds,
    std::vector<int32_t> &optionLabels,
 ...
 * Destructor
 */
CdsBoolDiscreteSetting::~CdsBoolDiscreteSetting()
{

}

DiscreteOptionsCollection CdsBoolDiscreteSetting::getOptionLabels()
{
  return optionLabels_;
}

DiscreteOptionsCollection CdsBoolDiscreteSetting::getOptionValues()
{
 ...
 */
std::string CdsBoolDiscreteSetting::getStringValue()
{
...
void CdsBoolDiscreteSetting::setValue(int32_t optionValue)
{
  Cds::CdsResult result;
  ...
  result = cdsObject_->set((bool&)optionValue);
  assert_removable(result == Cds::CDS_SUCCESS);
