...
////////////////////////////////////////////////////////////////////////////////
/**
 *  @file   CdsInt32DiscreteSetting.cpp
 ...
 * Constructor
 */
CdsInt32DiscreteSetting::CdsInt32DiscreteSetting(int32_t settingId, ICds* cds,
 ...
 * Destructor
 */
CdsInt32DiscreteSetting::~CdsInt32DiscreteSetting()
{

}

DiscreteOptionsCollection CdsInt32DiscreteSetting::getOptionLabels()
{
  return optionLabels_;
}

DiscreteOptionsCollection CdsInt32DiscreteSetting::getOptionValues()
{
 ...
 */
std::string CdsInt32DiscreteSetting::getStringValue()
{
...
void CdsInt32DiscreteSetting::setValue(int32_t optionValue)
{
  Cds::CdsResult result;
